...
public class Psf {
    ...
    public static void main(String[] args) {
        ...
        //--------------------------------------------------------
        //--------------------------------------------------------
        //Verificando quantas consultas o médico tem   
        
        c.setQtdConsulta(c.getQtdConsulta() + 1);
        System.out.println("A quantidade de consultas nesse dia será de: "+c.getQtdConsulta());
